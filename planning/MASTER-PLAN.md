...
| Client — unit tests | ✅ 50 Jest tests green (sim-engine tests retired with the sim layer) |
| Client — **simulation layer removed** (real-only: no demo Pi, no fake values, honest placeholders) | ✅ 2026-08-09 |
...
| Real telemetry on a physical Pi | ✅ **Verified on a real Pi 5 (Debian trixie)** — installer sets up the background service; app shows live temp/CPU/mem/net; shell works; service auto-restarts on crash and survives terminal close (2026-08-09) |
